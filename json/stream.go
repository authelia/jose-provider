...
//
// Deprecated: Use [Decoder.SetNumberType] instead.
func (dec *Decoder) UseNumber() { dec.d.numberType = UnmarshalJSONNumber }

// SetNumberType causes the Decoder to unmarshal a number into an interface
// value as a [Number], float64 or int64 depending on the value of t.
